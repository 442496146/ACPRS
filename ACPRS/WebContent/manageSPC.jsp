...
%>
<body style = "padding: 60px;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ACPRS/WebContent/manageSPC.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ACPRS/WebContent/manageSPC.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ACPRS/WebContent/manageSPC.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ACPRS/WebContent/manageSPC.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ACPRS/WebContent/manageSPC.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ACPRS/WebContent/manageSPC.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ACPRS/WebContent/manageSPC.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ACPRS/WebContent/manageSPC.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ACPRS/WebContent/manageSPC.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ACPRS/WebContent/manageSPC.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ACPRS/WebContent/manageSPC.jsp">
			...
			<div>
				<ul class="nav navbar-nav navbar-left">
					...
					<li class="dropdown active">
						...
						<ul class="dropdown-menu">
							<li class="active"><a href="manageSPC.jsp">管理SPC成员</a></li>
	...
	<div class="container"> 
		<form action="DelSPC" method="get">          
		<table class="table table-hover" id="member">
			<caption>SPC成员</caption>
			<thead>
				<tr>
					<th></th>
					<th>人员编号</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-title">
                    <h1 class="text-center">添加SPC成员</h1>
                </div>
                <div class="modal-body">
                    <form class="form-group" method="post" action="AddSPCMember">
